...
local fire_mode_default = 
{
	...
	projectile_number =   1,
	projectile_spread =   Projectile_Deviation(0, 100), // default inaccuracy of a single projectile
	spread =              Projectile_Deviation(1, 100), // inaccuracy from prolonged firing

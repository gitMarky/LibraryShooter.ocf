...
/**
	...
	Checks {@link Library_Firearm#IsWeaponReadyToUse} and {@link Library_Firearm#IsUserReadyToUse}.
	For custom behaviour modify those functions.
...
func DoStartAiming(object user) // TODO: Move this to a separate class/interface sort of thing
{
